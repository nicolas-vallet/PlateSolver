...
public interface TychoStarRepository extends JpaRepository<TychoStar, String> {
	...
	public TychoStar findByTychoIdentifier(String id);
	
	public TychoStar findByHpNumber(Integer hpNumber);
	...
	public List<TychoStar> findByEQCoordinatesArea(double RAmax, double DECmax, double RAmin,
			double DECmin);
}
